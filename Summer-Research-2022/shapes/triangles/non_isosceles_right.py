...
class NonIsoscelesRight(): 
    ...
    def coordinatize(self):
        ...
        # we have 6 scenarios at 0 degrees: 30, 60, and 90 degrees above and below the x axis
        ...
        if vertex_gluing == True:
            ...
            # 6 scenarios * 9 angles = 54 new scenarios
            # 60 scenarios in total
    ...
    # return a list of Point objects. there are six options: 30, -30, 60, -60, 90, -90 degrees.
