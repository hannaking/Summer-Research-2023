...
# 6 sides of equal length, all angles are 120 degrees
...
class Hexagon(): 
    ...
    def coordinatize(self):
        ...
        scenarios = [[pt1, pt2, pt3, pt4, pt5, pt6],
        ...
        if (sorted_points[5] == None): # five known points
            ...
            scenarios[0][5] = Geometry.calculate_point_from_angle(ANGLE, scenarios[0][4], scenarios[0][3], side_length)
            scenarios[1][5] = Geometry.calculate_point_from_angle(-ANGLE, scenarios[1][4], scenarios[1][3], side_length)

        # all six points known handled above
